...
G4VPhysicalVolume* CRAB_CSG::Construct(){
    ...
    // Field Cage Rings
    G4VPhysicalVolume * FR_FC_10 = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 + 5*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_9  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 + 4*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_8  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 + 3*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_7  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 + 2*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_6  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 + 1*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_5  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_4  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 - 1*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_3  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 - 2*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_2  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 - 3*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_FC_1  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 - 4*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);


    // // EL Field Rings
    G4VPhysicalVolume * FR_EL_3  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - 1.3*cm - 0.7*cm - 1.3*cm - 2*cm - FR_thick - 2*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_EL_2  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - 1.3*cm - 0.7*cm - 1.3*cm - 2*cm - FR_thick - 1*(FR_thick + PEEK_Rod_thick)+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * FR_EL_1  = new G4PVPlacement(0, G4ThreeVector(0,0, -FR_thick/2.0 - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - 1.3*cm - 0.7*cm - 1.3*cm - 2*cm - FR_thick+Offset), FR_logic, FR_logic->GetName(), gas_logic, 0, 0, false);
    ...
    G4VPhysicalVolume * PEEK_FC_10_1  = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, 1*cm/2.0 + 5*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic_cathode, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_9_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0 + 4*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_8_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0 + 3*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_7_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0 + 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_6_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0 + 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_5_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_4_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0 - 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_3_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0 - 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_2_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0 - 3*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_1_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0 - 4*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);

    G4VPhysicalVolume * PEEK_FC_10_2  = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, 1*cm/2.0  + 5*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic_cathode, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_9_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  + 4*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_8_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  + 3*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_7_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  + 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_6_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  + 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_5_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0 +Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_4_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  - 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_3_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  - 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_2_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  - 3*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_1_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  - 4*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);

    G4VPhysicalVolume * PEEK_FC_10_3  = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, 1*cm/2.0 + 5*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic_cathode, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_9_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  + 4*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_8_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  + 3*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_7_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  + 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_6_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  + 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_5_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0 +Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_4_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  - 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_3_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  - 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_2_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  - 3*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_FC_1_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  - 4*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);


    G4VPhysicalVolume * PEEK_EL_1_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, 1.1*cm/2.0          - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick+Offset), PEEK_logic_buffer, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_EL_2_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0  - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick - 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_EL_3_1   = new G4PVPlacement(0, G4ThreeVector(0,-5*cm, PEEK_Rod_thick/2.0  - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick - 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    ...
    G4VPhysicalVolume * PEEK_EL_1_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, 1.1*cm/2.0          - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick+Offset), PEEK_logic_buffer, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_EL_2_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick - 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_EL_3_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, PEEK_Rod_thick/2.0  - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick - 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_EL_4_2   = new G4PVPlacement(0, G4ThreeVector(x_rot_2, y_rot_2, 3.37*cm/2.0         - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick - 2*(FR_thick + PEEK_Rod_thick) - FR_thick - 3.37*cm+Offset), PEEK_logic_buffer_end, PEEK_logic->GetName(), gas_logic, 0, 0, false);

    G4VPhysicalVolume * PEEK_EL_1_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, 1.1*cm/2.0          - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick+Offset), PEEK_logic_buffer, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_EL_2_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick - 1*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_EL_3_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, PEEK_Rod_thick/2.0  - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick - 2*(FR_thick + PEEK_Rod_thick)+Offset), PEEK_logic, PEEK_logic->GetName(), gas_logic, 0, 0, false);
    G4VPhysicalVolume * PEEK_EL_4_3   = new G4PVPlacement(0, G4ThreeVector(x_rot_3, y_rot_3, 3.37*cm/2.0         - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick - ElGap_ - EL_thick - 2*cm - FR_thick - 2*(FR_thick + PEEK_Rod_thick) - FR_thick - 3.37*cm+Offset), PEEK_logic_buffer_end, PEEK_logic->GetName(), gas_logic, 0, 0, false);


    // EL_Gap
    new G4PVPlacement(0, G4ThreeVector(0.,0.,EL_pos+Offset),EL_logic,EL_solid->GetName(),gas_logic, 0,0, false);

    G4VPhysicalVolume * EL_Ring_Plus        = new G4PVPlacement(0, G4ThreeVector(0.,0., EL_thick/2.0 - FR_thick - 4*(FR_thick + PEEK_Rod_thick) - 2.5*cm - EL_thick+Offset), EL_ring_logic, EL_solid->GetName(), gas_logic, 0,0, false);
    ...
    // PMT Tubes
    G4VPhysicalVolume *PMT_Tube_Phys0=new G4PVPlacement(0,G4ThreeVector(0, 0, PMT_pos + LongPMTTubeOffset+Offset),     PMT_Tube_Logic0,PMT_Tube_Logic0->GetName(),lab_logic_volume,false,0,false);
    ...
    // PMT Tube Block
    new G4PVPlacement(0,G4ThreeVector(0,0, PMT_pos-PMT_offset+PMT_Tube_Length0-PMT_Tube_Block_Thickness/2+LongPMTTubeOffset+Offset),PMT_Block_Logic0,PMT_Block_Logic0->GetName(),lab_logic_volume,false,0,false);
    new G4PVPlacement(0,G4ThreeVector(0,0, -(PMT_pos-PMT_offset+PMT_Tube_Length1-PMT_Tube_Block_Thickness/2)-offset+Offset),        PMT_Block_Logic,PMT_Block_Logic->GetName(),lab_logic_volume,false,1,false);

    // PMTs
    // new G4PVPlacement(pmt1rotate,G4ThreeVector (0,0,((PMT3_Pos_)-pmt1_->Length()/2-PMT_Tube_Length1/2-MgF2_window_thickness_/2+Offset)),pmt1_logic,pmt1_->GetPMTName(),InsideThePMT_Tube_Logic0,true,0,false);
    new G4PVPlacement(0,G4ThreeVector (0, 0., (PMT1_Pos_-pmt1_->Length()/2-MgF2_window_thickness_/2)+Offset),pmt2_logic,pmt2_->GetPMTName(),InsideThePMT_Tube_Logic1,true,0,false);
    ...
    G4VPhysicalVolume* camPhysical= new G4PVPlacement(0,  G4ThreeVector (0,0, (chamber_length/2 + chamber_thickn + ImageDist+Offset) - PMT_pos-LongPMTTubeOffset),camLogical,"camPhysical",InsideThePMT_Tube_Logic0, false,0,false);
    ...
    // Brackets
    G4VPhysicalVolume* bracketPhysical1 = new G4PVPlacement(0,  G4ThreeVector (0,(-5.7)*cm, EL_pos+Offset),bracket_logical,"bracketPhysical",gas_logic, false,0,false);
    G4VPhysicalVolume* bracketPhysical2 = new G4PVPlacement(rotateZ_120,  G4ThreeVector (x_rot_2, y_rot_2, EL_pos+Offset),bracket_logical,"bracketPhysical",gas_logic, false,0,false);
    ...
    if(!HideSourceHolder_){
        ...
        G4ThreeVector CollPosition={NeedlePos[0],NeedlePos[1]-5*mm,NeedlePos[2]+Offset};
