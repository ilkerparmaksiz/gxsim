...
PhysicsListMessenger::PhysicsListMessenger(PhysicsList* pPhys)
    : pPhysicsList(pPhys) {
  physDir = new G4UIdirectory("/MWGPC/phys/");
  physDir->SetGuidance("MWGPC physics list commands");

  gammaCutCmd = new G4UIcmdWithADoubleAndUnit("/MWGPC/phys/setGCut", this);
  ...
  electCutCmd = new G4UIcmdWithADoubleAndUnit("/MWGPC/phys/setECut", this);
  ...
  protoCutCmd = new G4UIcmdWithADoubleAndUnit("/MWGPC/phys/setPCut", this);
  ...
  allCutCmd = new G4UIcmdWithADoubleAndUnit("/MWGPC/phys/setCuts", this);
  ...
  pListCmd = new G4UIcmdWithAString("/MWGPC/phys/InitializePhysics", this);
  ...
  addParamCmd = new G4UIcmdWithoutParameter("/MWGPC/phys/AddParametrisation", this);
  addParamCmd->SetGuidance("Add the parametrisation");
  addParamCmd->AvailableForStates(G4State_PreInit);

  lowLimitECmd = new G4UIcmdWithADoubleAndUnit("/MWGPC/phys/setLowLimitE", this);
